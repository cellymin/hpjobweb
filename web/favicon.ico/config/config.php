...
if (!defined("PATH_LC"))
    exit;
/**
 * Copyright              [LC框架] (C)2011-2012 快乐网，Inc.
 * Encoding               UTF-8
...
//URL设置
    "URL_REWRITE" => 0, //url重写模式 使用方式请参考LC手册   如果设置错误 网站将无法访问
    "URL_TYPE" => 1, /*
...
//模板参数
    "TPL_ENGINE" => "hd", //模板引擎  支持smarty模版引擎与LC快乐模版引擎  建议使用LC模版引擎 效率及扩展性更高
...
//邮箱配置
    ...
    "replyusername" => "快乐论坛", //收件人回复邮箱时显示的用户名
    "frommail" => "houdunwangdemo@126.com", //发送人发件箱显示的邮箱址址,设置和replymail一样即可，也可不设置
    "fromname" => "快乐论坛", //发送人发件箱显示的用户名，设置和replyusername一样即可，也可不设置
);
