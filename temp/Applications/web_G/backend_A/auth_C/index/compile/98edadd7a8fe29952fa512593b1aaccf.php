    ...
    <body>
         <div class="opt-notice opt-notice-error">
            ...
            <div class="notice-con">
                ...
                <p class="link"><span id="time"><?php echo $time;?></span>秒钟后将进行<a href="javascript:http://www.hap-job.com/index.php/backend/auth/index">跳转</a>也可以<a href="http://www.hap-job.com/index.php/backend">返回首页</a></p>
            </div>
        </div>
        <script type="text/javascript">
