...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <link type="text/css" rel="stylesheet" href="http://www.hap-job.com/web/backend/templates/css/login.css"/> 
    </head>
    <body>
        <div id="header">
    ...
    <div class="container-fluid">
        ...
        <div class="loginContainer" id="login-panel">
            <form method="post" action="http://www.hap-job.com/index.php/backend/auth/index" id="loginForm" >
                <table>
                    <tr>
                    ...
                    <tr>
                        <td class="code">
                            ...
                            <img src="http://www.hap-job.com/index.php/index/auth/validateCode.html" onclick="javascript:this.src='http://www.hap-job.com/index.php/index/auth/validateCode?next='+Math.random();return false;">
                        </td>
                    </tr>
                    <?php }?>
                </table>
