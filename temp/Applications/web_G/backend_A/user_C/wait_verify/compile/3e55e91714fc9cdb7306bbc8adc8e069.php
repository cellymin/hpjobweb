...
<body>
<form action="http://www.hap-job.com/index.php/backend/user/wait_verify" method="get" id="search-form">
...
<script type="text/javascript">
    ...
    function updateAuditCheck(arg){//批量处理（审核）
        console.log(arg);
        $.post('http://www.hap-job.com/index.php/backend/user/updateAuditCheck',{id:arg.id,type:arg.a_name},function(data){
//            if(data.verify==1){
