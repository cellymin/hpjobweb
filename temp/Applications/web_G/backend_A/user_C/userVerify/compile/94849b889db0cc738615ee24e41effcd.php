...
<body>
<div id="userList">
    <form action="http://www.hap-job.com/index.php/backend/user/userVerify" method="get" id="search-form">
        <table class="table well" style="margin-bottom:-18px;">
            <tr>
                <th colspan="1">筛选用户</th>
                <th><input type="text" name="username" class="input-medium" value="<?php if(isset($_GET['username'])){?><?php echo $_GET['username'];?><?php }?>"></th>
                ...
                <th>
                    <select name="verify" class="input-medium" <?php if(isset($_GET['verify'])){?>select="<?php echo $_GET['verify'];?>"<?php }?>>
                    <option value="">请选择</option>
