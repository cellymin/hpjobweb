...
<body>
<form id="company-data-form" validate="true" method="post" action="http://www.hap-job.com/index.php/backend/user/sendMessage">
<table>
    <tr>
        <th>消息内容&nbsp;&nbsp;&nbsp;&nbsp;</th>
