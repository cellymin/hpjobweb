...
<ul class="son">
	...
	<li><a href="http://www.hap-job.com/index.php/<?php echo $three_menu['app'];?>/<?php echo $three_menu['control'];?>/<?php echo $three_menu['method'];?><?php echo $three_menu['query_string'];?>" target="opt"><?php echo $three_menu['menu_name'];?></a></li>
	<?php }?><?php endif;?>
</ul>
</li>
<li>
