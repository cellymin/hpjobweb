...
<meta name="keywords" content="快乐工作" />
<meta name="description" content="快乐工作" />
<link type="text/css" rel="stylesheet" href="http://hap-job.com/public/css/base.css"/>
<link type="text/css" rel="stylesheet" href="http://hap-job.com/templates/default/css/search.css"/>
...
<link type="text/css" rel="stylesheet" href="http://hap-job.com/public/js/artDialog/skins/green.css"/>
...
<div class="cond-switch"> <span id="keyword-area">
  <form method="get" id="search" action="http://hap-job.com/index.php/index/search/">
...
<tr class="list-head">
    ...
    <td><?php if($spread['cate_id']==5){?>
        <a class="job-title" href="http://hap-job.com/index.php/index/search/jobs/id/<?php echo $spread['recruit_id'];?>.html" target="_blank"><?php echo $spread['recruit_name'];?></a> <img src="http://hap-job.com/templates/default/images/ding.gif" alt="" /> 
        <?php  }elseif($spread['cate_id']==2){ ?>
        <a class="job-title" href="http://hap-job.com/index.php/index/search/jobs/id/<?php echo $spread['recruit_id'];?>.html" target="_blank"><?php echo str_ireplace($keywords,$keywords_replace,$spread['recruit_name']);?></a> <img src="http://hap-job.com/templates/default/images/ji_.gif" alt="" /> 
        <?php  }elseif($spread['cate_id']==6){ ?>
        <a class="job-title" style="color: <?php echo $spread['color'];?>" href="http://hap-job.com/index.php/index/search/jobs/id/<?php echo $spread['recruit_id'];?>.html" target="_blank"><?php echo $spread['recruit_name'];?></a>
        <?php  }else{ ?><a class="job-title" href="http://hap-job.com/index.php/index/search/jobs/id/<?php echo $spread['recruit_id'];?>.html" target="_blank"><?php echo $spread['recruit_name'];?></a><?php }?></td>
	<td c_id="<?php echo $spread['uid'];?>"><a href="http://hap-job.com/index.php/index/index/company/id/<?php echo $spread['uid'];?>.html" target="_blank" class="job-company"><?php echo $spread['company_name'];?></a></td>
...
<tr class="job-info">
    ...
    <a href="<?php echo $spread['recruit_id'];?>"><img src="http://hap-job.com/templates/default/images/list_36.gif" alt="" /></a>
    </td>
</tr>
    <?php }?><?php endif;?>
    ...
    <td><a class="job-title" href="http://hap-job.com/index.php/index/search/jobs/id/<?php echo $job['recruit_id'];?>.html" target="_blank"><?php echo str_ireplace($keywords,$keywords_replace,$job['recruit_name']);?></a></td>
	<td c_id="<?php echo $job['uid'];?>"><a href="http://hap-job.com/index.php/index/index/company/id/<?php echo $job['uid'];?>.html" target="_blank" class="job-company"><?php echo $job['company_name'];?></a></td>
...
<tr class="job-info">
    ...
    <td class="apply-button">
    <a href="<?php echo $job['recruit_id'];?>"><img src="http://hap-job.com/templates/default/images/list_36.gif" alt="" /></a>
    </td>
</tr>
    <?php }?><?php endif;?>
    <!--/遍历普通职位-->
...
<script type="text/javascript">
var url='http://hap-job.com/index.php',
    app='http://hap-job.com/index.php/index';
</script>
<script type="text/javascript" src="http://hap-job.com/templates/default/js/search.js"></script>
<?php if(!defined("PATH_LC"))exit;?>
</body>
</html>