...
<head>
    ...
    <script src="http://www.hap-job.com/templates/default/app/js/WeixinApi.js"></script>
    <link href="http://www.hap-job.com/templates/default/app/css/css.css" rel="stylesheet" type="text/css">
    <script src="http://www.hap-job.com/templates/default/app/js/zepto.min.js"></script>
    <script src="http://www.hap-job.com/templates/default/app/js/layer.m/layer.m.js"></script>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
</head>
<body id="yem">
    <div class="page">
        <section>
            <div class="top" style="visibility: hidden;"><img src="http://www.hap-job.com/templates/default/app/images/yuan.png"></div>
                ...
                <div class="bottom" style="margin-top: 30px;">
                    ...
                    <img src="http://www.hap-job.com/templates/default/app/images/xzapp.png" onclick="dosubmit();">
                </div>
        </section>
...
<script>
    ...
    function dosubmit(){
        ...
        $.post('http://www.hap-job.com/index.php/app/auth/share',{
            'code':_code,
            'phone':_phone,
            'from':_from,
            'branch_id':branch_id,
    ...
    function sendSms(object){
        ...
        $.post('http://www.hap-job.com/index.php/app/auth/sendSmsForShare',{
            'phone':_phone
        },function(data){
            layer.open({
                content: data.msg,
...
//    document.getElementById("hqyzm").onclick=function(){,sendSms();}
    ...
    function time(o) {
        ...
        if (wait == 0) {
            ...
            o.style.cssText = 'background:url("http://www.hap-job.com/templates/default/app/images/bka.png") center no-repeat;background-size: 100%;';
            wait--;
            setTimeout(function() {
                        time(o)
                    },
