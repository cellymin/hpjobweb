...
load_file(PATH_LC . '/libs/usr/db/driver/mysql.class.php');

/**
 * 
* @ClassName: mysqliDriver
* @Description: todo(mysqli数据库驱动)
* @author zhouchao
* @date 2014-12-30 上午8:34:55
 */
