...
load_file(PATH_LC . '/libs/usr/view/view.class.php');
/**
 * 
* @ClassName: baseView
* @Description: todo(视图处理类)
* @author zhouchao
* @date 2014-12-30 上午8:53:38
 */
final class baseView extends view {
...
//            header("Content-type:" . $contentType . ';charset=' . $charset);
    ...
    public function compile() {
        ...
        if (!$this->checkCompile())
            return;
        load_file(PATH_LC . '/libs/usr/view/base/compile.class.php');
