 ...
 * 
* @ClassName: Model
* @Description: todo(模型构造类)
* @author zhouchao
* @date 2014-12-30 上午8:37:33
 */
class Model extends lcphp {
    ...
    /**
     * 执行一个SQL语句  没有有返回值 
     * 示例：$db->exe("delete from news where id=16");
     */
    public function exe() {
        $opt = func_get_args();
...
//获得MYSQL版本
    ...
    public function validate($data = null) {
        ...
        if (!is_array($this->validate)) {
            error(L("model_validate_error"), false); //验证规则定义错误，是不是打错了
        }
