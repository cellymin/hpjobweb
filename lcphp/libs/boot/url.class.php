...
final class url {
    ...
    static private function set_url_const() {
        ...
        define("__TPLC__", CONTROL ."/". METHOD); //模板文件地址
...
//
//        var_dump(substr($_SERVER['REQUEST_URI'],0,10));
//
//        $_SERVER['REQUEST_URI'] = substr($_SERVER['REQUEST_URI'],0,10)=='/index.php'?$_SERVER['REQUEST_URI']:'/index.php'.$_SERVER['REQUEST_URI'];
