...
//基本参数
    ...
    "DEBUG" => 1, //开启调试模式
    "DEBUG_AJAX" => 1, //AJAX异步时关闭调试信息显示   1 为显示调试信息  0 关闭调试信息
...
//SESSION
    "SESSION_NAME" => "lcsid", //储存SESSION_ID的COOKIE名
    "SESSION_ENGINE" => 'file', //file文件 mysql数据库处理 memcache为memcache缓存处理
    "SESSION_LIFTTIME" => 1728000, //在线保持时间(秒)SESSION过期时间
...
//图像水印处理
    "WATER_ON" => 0, //水印开关
    "WATER_FONT" => PATH_LC . "/data/font/font.ttf", //水印字体
    "WATER_IMG" => PATH_LC . "/data/water/water.png", //水印图像
    "WATER_POS" => 9, //水印位置
    "WATER_PCT" => 60, //水印透明度
...
//图片缩略图
    ...
    "THUMB_PATH" => "", //缩略图路径
//验证码
    "CODE_FONT" => PATH_LC . "/data/font/font.ttf", //验证码字体
...
//模板参数
    ...
    "EDITOR_MAX_STR" => 100000, // 编辑器允许输入最大字数
...
//日志处理
    ...
    "LOG_KEY" => "longseen.com", //日志文件保密密匙串
    "LOG_SIZE" => 2000000, //日志文件大小
    "LOG_TYPE" => array("error", "notice", "sql"), //保存日志类型
//邮箱配置
    "email_username" => "admin@longseen.com", //发送邮件邮箱用户名
    "email_password" => "longseen2014", //发送邮件邮箱密码
    ...
    "replymail" => "admin@longseen.com", //收件人回复邮箱时显示的邮箱地址
    "replyusername" => "上海良臣", //收件人回复邮箱时显示的用户名
    "frommail" => "admin@longseen.com", //发送人发件箱显示的邮箱址址,设置和replymail一样即可，也可不设置
    "fromname" => "上海良臣", //发送人发件箱显示的用户名，设置和replyusername一样即可，也可不设置
);
